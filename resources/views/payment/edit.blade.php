...
@section('content_header')
    ...
    <div class="form-group">
                    ...
                    <select id="gender" name="gender" class="form-control" value="{{$payment->method}}" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" id="amount" name="amount" class="form-control" value="{{$payment->amount}}" required step="0.01" min="0">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" id="date" name="date" class="form-control" value="{{$payment->date}}" required step="0.01" min="0">
                    </div>
                </div>

                <div class="form-group">
                    <label for="currency_type">Tipo de moneda</label>
                    <select id="currency_type" name="currency_type" class="form-control" value="{{$payment->currency_type}}"  required>
                ...
                <div class="form-group">
                    ...
                    <select name="reservation_id" id="reservation_id" class="form-control" value="{{$payment->reservation_id}}">
